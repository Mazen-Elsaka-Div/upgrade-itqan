...
export default function HeaderNavClient({
  ...
  return (
    <motion.header
      ...
      className="sticky top-4 z-50 px-6 sm:px-10 relative"
    >
      <div className="max-w-5xl mx-auto bg-hp-parchment/90 dark:bg-hp-dark/90 backdrop-blur-md border border-hp-ink/10 dark:border-hp-cream/10 shadow-lg rounded-full px-6 sm:px-10 flex items-center justify-between h-16">
        {/* Logo */}
