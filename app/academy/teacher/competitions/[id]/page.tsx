  ...
  if (!competition) {
    return (
      <div className="text-center py-16">
        <p className="text-muted-foreground">المسابقة غير موجودة أو غير مُسندة إليك</p>
                  ...
                  {entry.score !== null && (
                    <div className="mt-2 flex items-center gap-2">
                      ...
                      {entry.evaluated_by_name && (
                        <span className="text-xs text-muted-foreground">— بواسطة {entry.evaluated_by_name}</span>
                      )}
                    </div>
                  )}
                  {entry.feedback && (
