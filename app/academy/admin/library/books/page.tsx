...
export default function AdminLibraryBooksPage() {
  ...
  const fetchBooks = useMemo(
    () => async (q: string) => {
      ...
      try {
        ...
        const res = await fetch(`/api/academy/admin/library/books?${params.toString()}`)
  ...
  const onDelete = async (id: string) => {
    ...
    setDeletingId(id)
    try {
      const res = await fetch(`/api/academy/admin/library/books/${id}`, { method: "DELETE" })
      if (!res.ok) throw new Error()
  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-5" dir="rtl">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <Link href="/academy/admin/library/books/new">
                  ...
                  <tr key={b.id} className="hover:bg-muted/30">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <Link href={`/academy/admin/library/books/${b.id}/edit`}>
