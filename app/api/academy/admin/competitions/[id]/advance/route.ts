...
// POST: perform a stage action.
//   action = 'advance'      → advance top-N to next stage (or finalize if final)
//   action = 'finalize_now' → finalize the current stage as the official result
//   action = 'cancel'       → cancel the competition (no winner), notify participants
